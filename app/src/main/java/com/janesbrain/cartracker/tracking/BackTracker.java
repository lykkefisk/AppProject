...
public class BackTracker {
    ...
    private IUpdateBackTracking listener;
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination + "&key=" + GOOGLE_MAP_KEY;
    }
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            ...
            route.SetAddresses(jsonLeg.getString("start_address"),jsonLeg.getString("end_address"));
